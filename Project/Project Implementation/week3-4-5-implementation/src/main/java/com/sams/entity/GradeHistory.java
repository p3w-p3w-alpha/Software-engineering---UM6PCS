...
// this entity tracks all changes made to grades for audit purposes
// provides a complete history of grade modifications
@Entity
...
public class GradeHistory {
    ...
    // reference to the grade that was modified
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "grade_id", nullable = false)
    private Grade grade;

    // the previous grade value before the change
