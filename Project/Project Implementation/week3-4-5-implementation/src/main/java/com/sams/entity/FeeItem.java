...
/**
 * Entity representing an individual fee item within a payment
 * Breaks down a payment into specific fee components (tuition, library, lab, etc.)
 */
@Entity
...
public class FeeItem {
    ...
    // the payment this fee item belongs to
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "payment_id", nullable = false)
    private Payment payment;

    // the fee structure this item is based on
    @ManyToOne(fetch = FetchType.LAZY)
