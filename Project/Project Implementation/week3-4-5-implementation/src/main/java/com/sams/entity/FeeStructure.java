...
/**
 * Entity representing a fee structure/type in the system
 * Defines different types of fees (tuition, library, lab, hostel, exam, etc.)
 */
@Entity
...
public class FeeStructure {
    ...
    // fee name (e.g., "Tuition Fee", "Library Fee", "Lab Fee")
    @NotBlank
    @Column(nullable = false, unique = true, length = 100)
    private String feeName;

    // fee code (e.g., "TUITION", "LIBRARY", "LAB")
    @NotBlank
