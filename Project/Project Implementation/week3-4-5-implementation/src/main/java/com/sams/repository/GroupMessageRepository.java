...
public interface GroupMessageRepository extends JpaRepository<GroupMessage, Long> {
    ...
    // find all messages in a group (non-deleted only), ordered by most recent, with pagination
    ...
    // find all file-type messages in a group (for file browser feature)
    ...
    // find recent messages in a group (last N messages) - useful for quick preview
    ...
    // chekc if a user has sent any messages in a group
    ...
    // search messages in a group by content (case insensitive)
