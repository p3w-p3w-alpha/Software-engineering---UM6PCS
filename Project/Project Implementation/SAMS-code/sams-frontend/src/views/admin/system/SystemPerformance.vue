<!--
  System Performance Monitor - admin dashboard for monitoring system health and metrics
  took a while to get the real-time updates working properly
  wierd but useful for tracking server performance
-->
<template>
  <div class="system-performance min-h-screen bg-gray-50 p-6">
    <!-- Header section with title and auto-refresh controls -->
    <div class="mb-6">
      <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <!-- Control Buttons - start/stop auto refresh of metrics -->
