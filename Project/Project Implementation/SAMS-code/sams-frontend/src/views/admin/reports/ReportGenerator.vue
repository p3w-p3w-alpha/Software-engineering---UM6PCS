<!--
  Report generator view - admin dashboard for creating custom reports
  this one was wierd to implement because of all teh different filter combinations
  definately the most complex form in teh entire admin section
-->
<template>
  <div class="report-generator p-6">
    <div class="mb-6">
      <!-- page header for report generation -->
    ...
    <!-- Report Type Selection - dropdown to choose which type of report to generate -->
    <Card class="mb-6">
      <template #content>
        <div class="space-y-4">
          <div>
