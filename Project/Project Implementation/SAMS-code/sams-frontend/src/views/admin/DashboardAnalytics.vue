<!--
  Admin dashboard for comprehensive analytics - shows all teh important metrics at a glance
  This is like the main control center where admins can see everything thats happening
  took a while to get the charts working properly but they look pretty good now
-->
<template>
...
<script setup>
// script section - handles all the data loading and chart setup
// using vue3 composition API becuase its more modern than options API
import { ref, onMounted } from 'vue'
import api from '@/services/api'
import LineChart from '@/components/charts/LineChart.vue'
import DoughnutChart from '@/components/charts/DoughnutChart.vue'

// reactive state for dashboard - holds all teh data we recieve from backend
