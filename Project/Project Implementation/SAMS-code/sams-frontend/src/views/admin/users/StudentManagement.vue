<!--
  Student Management view - admin dashboard for managing student accounts and enrollments
  this one has the most complex form validation becuase we recieve data from multiple sources
  took a while to get all the filters working correctly
-->
<template>
...
<script setup>
// student management script - handles CRUD operations for student accounts
// definately the most important view for managing thier academic records
...
// Toast notification state - wierd but works well for showing feedback
