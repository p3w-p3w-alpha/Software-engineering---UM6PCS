<!--
  Advanced Analytics Dashboard - admin dashboard for comprehensive insights and data visualization
  took a while to get the charts working but they look pretty good now
  definately the most complex view with all teh different metrics and graphs
-->
<template>
  <!-- Toast Notification - feedback messages for user actions -->
...
<script setup>
// analytics dashboard script - loads and displays comprehensive metrics
// wierd amount of data to handle but it all works together
import { ref, onMounted } from 'vue'
import api from '../../services/api'
import LoadingSpinner from '../../components/LoadingSpinner.vue'

// reactive state for analytics data and date range filtering
const loading = ref(true)
const dateRange = ref('30')

// Toast notification state - recieve feedback from operations
...
function exportReport() {
  showNotification('Report export functionality - Implement CSV/PDF export', 'success')
}
