<!--
  Settings page for admin dashboard - configure system-wide settings here
  complex form validation here to make sure everythign is correct
-->
<template>
  <div class="p-6">
    <div class="mb-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      <!-- Settings Menu - navigation tabs for diffrent settings sections -->
