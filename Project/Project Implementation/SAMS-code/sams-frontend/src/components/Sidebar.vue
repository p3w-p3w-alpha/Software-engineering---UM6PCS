<!--
  ...
  shows menu items with icons and badges for notifications
  handles active state highlighting - works for now
-->
...
const props = defineProps({
  title: {
    type: String,
    required: true  // sidebar header title
  },
  subtitle: {
    type: String,
  ...
  menuItems: {
    type: Array,
    required: true  // array of menu items with href, icon, name
  }
})

const route = useRoute()

// check if menu item is currently active - definately needed for highlighting
const isActive = (href) => {
