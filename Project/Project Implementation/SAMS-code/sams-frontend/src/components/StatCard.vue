<!--
  StatCard - animated statistic card component
  displays key metrics with icons, trends, and optional progress bars
  the hover animations took a while to get right
-->
...
<template>
  ...
  >
    <!-- Background decoration circle - subtle effect -->
...
// stat card props - lots of customization options
const props = defineProps({
  title: {
    type: String,
    required: true  // card title/label
  },
  value: {
    type: [String, Number],
    required: true  // main stat value
  },
  subtitle: {
    type: String,
    default: ''  // optional subtitle below value
  },
  icon: {
    type: [Object, Function],
    default: null  // heroicon component
  },
  color: {
    type: String,
    default: 'blue',
  ...
  trend: {
    type: String,
    default: null  // trend percentage like "+12%"
  },
  trendDirection: {
    type: String,
    default: 'up',
  ...
  progress: {
    type: Number,
    default: undefined  // optional progress bar 0-100
  },
  loading: {
    type: Boolean,
    default: false  // shows skeleton loader
  }
})
