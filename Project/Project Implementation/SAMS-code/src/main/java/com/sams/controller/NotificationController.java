...
/**
 * handles notification management - get, read, delete notifications
 * frontend polls this for unread count and notification list
 * supports pagination to avoid loading too many at once
 */
@RestController
