...
/**
 * handles dashboard analytics - stats, trends, financial summaries
 * frontend calls these for admin dashboard visualizations
 * returns aggregated data to avoid heavy queries
 */
@RestController
...
public class DashboardController {
    ...
    /**
     * gets enrollment trends over time - useful for charts
     * default is last 6 months if not specified
     */
