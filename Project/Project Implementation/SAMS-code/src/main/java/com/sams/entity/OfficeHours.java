...
/**
 * OfficeHours entity - teacher office hours for student consultations
 * teachers can define their availability for student meetings
 *
 * supports both in-person and online consultations which is nice
 * the recurring/one-time logic and cancellation handling was abit complex
 */
@Entity
...
public class OfficeHours {
    ...
    // The teacher whose office hours these are - one teacher has many office hours
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "teacher_id", nullable = false)
    private User teacher;

    // Day of the week - using enum is cleaner than integers
