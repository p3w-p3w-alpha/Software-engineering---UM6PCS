...
/**
 * TeacherProfile entity - extended profile info for faculty members
 * one-to-one relationship with User entity (role=FACULTY)
 *
 * lots of fields here but teachers have alot of info to track
 * the profileCompleted flag helps remind teachers to fill out thier profiles
 */
@Entity
...
public class TeacherProfile {
    ...
    // One-to-one relationship with User (faculty member) - enforced by unique constraint
