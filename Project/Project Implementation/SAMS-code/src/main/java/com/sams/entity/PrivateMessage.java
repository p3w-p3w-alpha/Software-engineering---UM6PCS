...
/**
 * PrivateMessage entity - one-on-one messages between connected users
 * tracks read status, deletion, and supports soft delete
 *
 * similar to group messages but for private conversations
 * read receipts occured to us later - was easy to add tho
 */
@Entity
