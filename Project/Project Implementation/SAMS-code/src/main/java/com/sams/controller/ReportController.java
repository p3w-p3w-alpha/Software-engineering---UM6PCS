...
/**
 * handles report generation - enrollments, fees, attendance, grades
 * frontend calls these for admin dashboards and data exports
 * returns simple map structures for easy consumption
 */
@RestController
