 ...
 * handles faculty profile creation, office hours scheduling, and availability
 *
 * supports: profile completion tracking, office hour booking, consultation types (in-person/online/both)
 * validates office hour overlaps and effective date ranges
 *
 * works pretty well but office hour validation logic was tricky to get right
 */
@Service
@Transactional
