 ...
 * handles file uploads, grading, late submissions with penalties
 *
 * validates file types based on assignment requirements
 * automaticaly calculates late penalties if assignment allows late submissions
 *
 * this was a pain to get right - so many edge cases with file handling
 */
@Service
public class SubmissionService {
    ...
    /**
     * Grade a submission
     * faculty can provide points and feedback - student gets notified automaticaly
     */
    @Transactional
