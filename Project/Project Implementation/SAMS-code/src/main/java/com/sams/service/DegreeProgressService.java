 ...
 * handles degree requirements and calculates if students are on track
 *
 * tracks: total credits, GPA, completion percentage, expected vs actual graduation date
 * determines if student meets graduation requirements
 *
 * TODO: need to properly implement requirement matching logic - works for now
 */
@Service
