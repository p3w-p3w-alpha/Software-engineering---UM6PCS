...
/**
 * handles file upload/download operations - assignments, profiles, materials
 * frontend uses this for all file-related operations
 * had to implement proper file validation to prevent security issues
 */
@RestController
