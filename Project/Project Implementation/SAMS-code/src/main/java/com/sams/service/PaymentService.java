 ...
 *
 * payment workflow: create -> student submits -> admin approves -> enrollments activate
 * had to accomodate partial payments and payment history tracking
 *
 * FIXME: should add refund functionality later
 */
@Service
public class PaymentService {
     ...
     * this automaticaly activates all enrollments tied to teh payment
     * dont forget to send notification to the student!
     */
    @Transactional
