...
/**
 * handles all grade operations - assigning, updating, finalizing grades
 * includes GPA calculation and grade history tracking
 *
 * uses the standard 4.0 grade scale (A=4.0, B=3.0, etc)
 * finalized grades cant be changed unless unfinalzied by admin
 *
 * this was wierd to implement - had to track every grade change for audit purposes
 */
@Service
public class GradeService {
    ...
    // tricky part was handling edge cases where student has no grades yet
