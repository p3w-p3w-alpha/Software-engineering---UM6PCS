...
/**
 * Semester entity - manages academic semesters/terms
 * helps control enrollment periods and academic scheduling
 *
 * the date logic here was tricky - took a while to get enrollment windows working
 * might need to add more fields later for better control
 */
@Entity
...
public class Semester {
    ...
    // semester name like "Fall 2024" or "Spring 2025" - human readable
    @NotBlank(message = "Semester name is required")
    @Column(nullable = false, length = 50)
    private String name;

    // short code like "F24" or "S25" - used in URLs and references
