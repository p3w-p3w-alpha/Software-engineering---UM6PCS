 ...
 * tracks all major actions in teh system for audit purposes
 *
 * logs: user creation, enrollments, grades, payments, etc
 * provides methods to query recent activities by type or user
 *
 * pretty simple service - just logs stuff to database
 */
@Service
@Transactional
