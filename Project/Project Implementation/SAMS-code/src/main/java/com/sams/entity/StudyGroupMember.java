...
/**
 * StudyGroupMember entity - represents membership in a study group
 * tracks role (ADMIN, MODERATOR, MEMBER) and status (ACTIVE, PENDING, REMOVED)
 *
 * join table between users and study groups basically
 * works fine for now but might need composite key later
 */
@Entity
...
public class StudyGroupMember {
    ...
    // role in the group: ADMIN, MODERATOR, MEMBER - admins can manage teh group
