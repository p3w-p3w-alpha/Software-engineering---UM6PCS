...
/**
 * handles private messaging between users - send, read, search messages
 * frontend calls this for one-on-one chat functionality
 * supports pagination and real-time via WebSocket
 */
@RestController
