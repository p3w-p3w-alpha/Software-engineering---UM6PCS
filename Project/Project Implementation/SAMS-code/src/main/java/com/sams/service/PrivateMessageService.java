 ...
 * users must be connected to send messages (enforces connection requirement)
 *
 * handles marking messages as read, deleting messages, searching conversation history
 * respects user blocking - cant message blocked users
 *
 * works pretty well, might add read receipts later
 */
@Service
