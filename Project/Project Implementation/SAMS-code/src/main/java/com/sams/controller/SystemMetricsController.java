...
/**
 * handles system metrics and health monitoring - CPU, memory, storage
 * frontend calls this for admin monitoring dashboards
 * only accessible to ADMIN and SUPER_ADMIN - dont expose to students
 */
@RestController
...
public class SystemMetricsController {
    ...
    /**
     * returns system health status - HEALTHY, WARNING, or CRITICAL
     * evaluates CPU, memory, storage to determine if action is needed
     * this one was tricky to get teh thresholds right
     */
    @GetMapping("/health")
    @PreAuthorize("hasAnyRole('ADMIN', 'SUPER_ADMIN')")
