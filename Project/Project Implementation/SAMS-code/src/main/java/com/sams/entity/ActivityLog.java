...
/**
 * ActivityLog entity - tracks system activity for audit purposes
 * logs user actions like enrollments, grade changes, payments etc
 *
 * the static factory methods are handy for creating common log entries
 * metadata field is JSON which is kind of hacky but flexible for extra data
 */
@Entity
...
public class ActivityLog {
    ...
    // Human-readable description of teh activity - for displaying in UI
