...
/**
 * handles admin user management - create, update, delete users
 * only ADMIN and SUPER_ADMIN can access these endpoints
 * make sure to validate role permissions before modifying users
 */
@RestController
