...
/**
 * provides all dashboard analytics and statistics
 * aggregates data from multiple services for admin dashboard views
 *
 * handles: user stats, enrollment trends, grade distributions, financial summaries,
 * demographics, and recent activity logs
 *
 * FIXME: some of these queries are slow with large datasets - need optimization
 * definately needs caching for production use
 */
@Service
...
public class DashboardService {
     ...
     * tries to get from ActivityLog first, falls back to user creation if no logs exist
     */
