...
/**
 * handles assignment CRUD operations and queries
 * frontend uses this for assignment creation, listing, updates
 * NOTE: file uploads are handled by seperate FileUploadController
 */
@RestController
