 ...
 * handles course enrollments and registration
 * needed this becuase we have complex enrollment validation rules
 */
@Repository
public interface EnrollmentRepository extends JpaRepository<Enrollment, Long> {

    // find all enrollments for a student - used in student schedule
