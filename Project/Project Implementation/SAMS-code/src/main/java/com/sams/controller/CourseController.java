...
/**
 * handles course management endpoints - CRUD, search, enrollment, waitlists
 * frontend calls these for course catalog and registration
 */
@RestController
...
public class CourseController {
    ...
    // adds prerequisite course requirement
    // make sure not to create circular dependencies here!
    ...
    // returns waitlist with position info for each student
    // frontend uses this to show students thier waitlist status
