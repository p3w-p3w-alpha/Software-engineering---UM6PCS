 ...
 * handles connection requests, blocking, and friend lists
 *
 * supports: sending requests, accepting/rejecting, blocking users, mutual connections
 * works like a social network friend system basicaly
 *
 * this was pretty straightforward to implement - no major issues
 */
@Service
